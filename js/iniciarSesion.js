...
const usuarios = [
  {
    usuario: "andreyna",
    clave: "Parraga12",
    departamento: "Oficina de Planeacion y Presupuesto",
  },
  {
    usuario: "usuario2",
    clave: "Clave2",
    departamento: "Direccion de Estimulo Creativo",
  },
  { usuario: "usuario3", clave: "Clave3", departamento: "Oficina de Gestion" },
  {
    usuario: "usuario4",
    clave: "Clave4",
    departamento: "Direccion de Investigacion",
  },
...
function iniciarSesion() {
  ...
  const seleccionIngresada = seleccionElement
    ? seleccionElement.textContent.trim()
    : "";
  ...
  if (usuarioIngresado === "" || claveIngresada === "") {
    ...
    spanError.innerHTML =
      'Los campos "Usuario" y "Clave" no pueden estar vacios';
    setTimeout(function () {
    ...
    const usuarioEncontrado = usuarios.find(
      (usuario) =>
        usuario.usuario === usuarioIngresado && usuario.clave === claveIngresada
    );
